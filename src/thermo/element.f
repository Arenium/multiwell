...
c%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      parameter (R=8.314472D+00)  ! J k-1 mol-1; CODATA Recommended Values of the Fundamental Physical Constants: 1998

      SAVE
c
c         MASS (atomic mass units) most from NIST/JANAF 1998 and some from 
c              NIST Standard Reference Database 144 [http://www.nist.gov/pml/data/comp.cfm,
c              last update July 2010]
...
c
        ...
        ELSEIF ( ATYPE.EQ.'Fe' ) THEN
         ...
         ELSEIF ( ATYPE.EQ.'S34' ) THEN
            MASS = 33.96786690D+00
            Hfxn = 4.412             ! assumed to be the same as "S"
            Sf = 32.056              ! assumed to be the same as "S"
         ELSEIF ( ATYPE.EQ.'S36' ) THEN
            MASS = 35.96708076D+00
            Hfxn = 4.412             ! assumed to be the same as "S"
            Sf = 32.056              ! assumed to be the same as "S"
