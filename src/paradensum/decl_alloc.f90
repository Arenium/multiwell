...
!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    !REAL(8), DIMENSION(:), ALLOCATABLE :: lowbound,upbound,gf
    ...
    REAL(8) perc_wind_overlap !NEW
    REAL(8) Emin, Emax, Emin_global, Emax_global !NEW
    REAL(8) Egrain1 , Egrain2 , Emax1 , Emax2 !NEW
    INTEGER(4) :: ngrains_per_wind_max, ngrains_to_add_max !NEW
...
CONTAINS
    ...
    SUBROUTINE alloc_2(ngrains, ngrains_to_add_max, ngrains_per_wind_max, nwalkers,nwind,ns)
       ...
       !INTEGER(4),INTENT(IN) :: ngrains, ngrains_to_add
       INTEGER(4),INTENT(IN) :: ngrains, ngrains_to_add_max !NEW
       ...
       !ALLOCATE ( gf(ngrains+ngrains_to_add), STAT = AllocateStatus)
       !IF (AllocateStatus /= 0) STOP "*** Not enough memory gf ***"
       !gf(:) = 0.d0
