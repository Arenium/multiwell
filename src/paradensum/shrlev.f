...
!        SUBROUTINE SHRLEV(Ttot,AT,DELE,JMAX,B,V,n1,n2,IMAX,zpe,
!     &          Vhr,Bhr,Phav,Phab,Nsig)
        SUBROUTINE SHRLEV(DELE,JMAX,B,V,n1,n2,IMAX_1,zpe_1,
     &          Vhr,Bhr,Phav_1,Phab_1,Nsig_1)
        ...
        CALL GHRLEV(EV_2,NN,IMAX_1,Emax,B,NCV,NCF,CV,CF,n1,n2,
